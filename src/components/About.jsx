...
const About = () => {
  return (
    <div className='w-full px-10 py-5 flex gap-8 md:flex-row  flex-col-reverse bg-slate-300'>
        ...
        <div className="basis-1/2">
           ...
           <div className="py-2 flex justify-center">
                <Button as={Link} color="danger" href="#" variant="flat" radius='full' className="px-9">
                    Learn More
                </Button>
           </div>
        </div>
