      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 flex flex-wrap justify-center gap-6">
          <div className="bg-white rounded-lg shadow p-6 w-80">
            <h3 className="text-xl font-medium text-gray-900">Digital Transformation Solutions</h3>
          ...
          <div className="bg-white rounded-lg shadow p-6 w-80">
            <h3 className="text-xl font-medium text-gray-900">Custom Software Development</h3>
          ...
          <div className="bg-white rounded-lg shadow p-6 w-80">
            <h3 className="text-xl font-medium text-gray-900">Strategic IT Consulting</h3>
